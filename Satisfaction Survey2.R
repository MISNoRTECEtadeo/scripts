...
#Walk in Data
setwd("S:/Esteban/Satisfaction Survey/September")

####### Open as a CSV

#Bring in data for responses 7/1/18-6/30/2019 ( I did this in excel to clean the data but would be better to have it here)
WalkIn_Survey <- read.csv("responses_export (Walk_in).csv", skip = 4, na.strings = c("", "NA")) 

Enrolled_Survey <- read.csv("responses_export (Enrolled).csv", skip = 4, na.strings = c("", "NA"))

Employer_Survey <- read.csv("responses_export (Businesses).csv", skip = 4, na.strings = c("", "NA"))
...
Enr_Column_names <- c("ID","Date","Respondent","Status","Alturas","Chico","Crescent.City","Grass.Valley"                                                                        
                  ...
                  ,"Please.Indicate.Any.Other.Services","Do.you.have.any.other.comments","Contact.Info.")
...
Bus_Column_names <- c("ID","Date","Respondent","Status","Alturas","Chico","Crescent.City","Grass.Valley","Oroville"
                  ...
                  ,"Strongly.Agree.-.I.will.recommend.your.services.to.others.","Please.indicate.any.other.services","Willing.ti.be.contacted?","Comments")                     
...
WalkIn_Survey <- WalkIn_Survey %>%
  filter(Dates >= "2019/07/01 01:00" & Dates <= "2019/09/30 01:00") # Change start and end dates
...
Comments_AFWD <- select(AFWD, StaffName, Date, 'Comment.-.Other.(Please.Indicate.Service.in.Comment)',"Please indicate any other services you would like to see us provide:", 'Do you have any other Comments?') 
...
write.xlsx(Comments_AFWD, "Comments_AFWD_Q1.xlsx")

Comments_STEP <- select(STEP, StaffName, Date, 'Comment.-.Other.(Please.Indicate.Service.in.Comment)','Do you have any other Comments?', "Please indicate any other services you would like to see us provide:") 
...
Comments_SMART <- select(SMART, StaffName, Date, 'Comment.-.Other.(Please.Indicate.Service.in.Comment)','Do you have any other Comments?', "Please indicate any other services you would like to see us provide:") 
...
Comments_JTC <- select(JTC, StaffName, Date, 'Comment.-.Other.(Please.Indicate.Service.in.Comment)','Do you have any other Comments?', "Please indicate any other services you would like to see us provide:") 
...
Enr_Comments_AFWD <- select(AFWD_Enr, Staff_Name, Date, 'Comment.-.Other.(Please.Indicate.Service.in.Comment)', 'Please.Indicate.Any.Other.Services','Do.you.have.any.other.comments') 
...
Enr_Comments_STEP <- select(STEP_Enr, Staff_Name, Date, 'Comment.-.Other.(Please.Indicate.Service.in.Comment)', 'Please.Indicate.Any.Other.Services','Do.you.have.any.other.comments') 
...
Enr_Comments_SMART <- select(SMART_Enr, Staff_Name, Date, 'Comment.-.Other.(Please.Indicate.Service.in.Comment)', 'Please.Indicate.Any.Other.Services','Do.you.have.any.other.comments') 
...
Emp_Comments_AFWD <- select(AFWD_Emp, Staff_Name, Date, 'Please.indicate.any.other.services','Comments', 'Comment.-.Other.(please.indicate.service.in.comment)') 
#Enr_Comments_SMART <- Emp_Comments_SMART[!is.na(Emp_Comments_SMART$'Please.indicate.any.other.services') & !is.na(Emp_Comments_SMART$'Comments') & !is.na(Emp_Comments_SMART$'Comment.-.Other.(please.indicate.service.in.comment)'),]
#Emp_Comments_AFWD <- remove_empty(Emp_Comments_AFWD[3:5], which = c("rows"))
write.xlsx(Emp_Comments_AFWD, "Emp_Comments_AFWD.xlsx")

Emp_Comments_STEP <- select(STEP_Emp, Staff_Name, Date, 'Please.indicate.any.other.services','Comments', 'Comment.-.Other.(please.indicate.service.in.comment)') 
#Emp_Comments_STEP <- remove_empty(Emp_Comments_STEP[3:5], which = c("rows"))
write.xlsx(Emp_Comments_STEP, "Emp_Comments_STEP.xlsx")

Emp_Comments_SMART <- select(SMART_Emp, Staff_Name, Date, 'Please.indicate.any.other.services','Comments', 'Comment.-.Other.(please.indicate.service.in.comment)') 
#Enr_Comments_SMART <- Emp_Comments_SMART[!is.na(Emp_Comments_SMART$'Please.indicate.any.other.services') & !is.na(Emp_Comments_SMART$'Comments') & !is.na(Emp_Comments_SMART$'Comment.-.Other.(please.indicate.service.in.comment)'),]
write.xlsx(Emp_Comments_SMART, "Emp_Comments_SMART.xlsx")

Emp_Comments_JTC <- select(JTC_Emp, Staff_Name, Date, 'Please.indicate.any.other.services','Comments', 'Comment.-.Other.(please.indicate.service.in.comment)') 
#Emp_Comments_JTC <- Emp_Comments_JTC[!is.na(Enr_Comments_SMART$'Please.indicate.any.other.services') & !is.na(Emp_Comments_STEP$'Comments') & !is.na(Emp_Comments_STEP$'Comment.-.Other.(please.indicate.service.in.comment)'),]
write.xlsx(Emp_Comments_JTC, "Emp_Comments_JTC.xlsx")
...
Second <- c("","", 'July 1, 2019 through September 30, 2019',"","","","","","","","","")    
...
write.xlsx(Final,"FINAL_Survey_2019_1st_Quarter.xlsx")   
